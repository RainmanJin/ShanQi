...
//						.newLatLngBounds(bounds, 100));
				mAMap.animateCamera(CameraUpdateFactory.newLatLngBoundsRect(bounds,100,100, MyApplication.height*3/7,200));
			} catch (Throwable e) {
				e.printStackTrace();
			}
		}
	...
	protected int getWalkColor() {
		return Color.parseColor("#70CD00");
	}

	/**
	 * 自定义路线颜色。
	 * return 自定义路线颜色。
	 * @since V2.2.1#D0011B 100%
	 */
