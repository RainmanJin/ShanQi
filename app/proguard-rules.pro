...
#-----------处理第三方依赖库---------
#-libraryjars libs/alipaySdk-20161129.jar  在android studio 不需要
...
-keep class com.handmark.pulltorefresh.library.PullToRefreshWebView {*;}

#-libraryjars libs/pgyer_sdk_x.x.jar 蒲公英
